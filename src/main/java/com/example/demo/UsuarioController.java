...
public class UsuarioController {
	...
	public String uploadfile(@ModelAttribute Usuario usuario,RedirectAttributes redirectAtributes) {
	     boolean isFlag = usuarioService.saveDataFromUploadfile(usuario.getFile1());
	     if(isFlag) {
