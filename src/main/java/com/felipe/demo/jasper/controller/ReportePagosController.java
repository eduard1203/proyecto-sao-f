...
public class ReportePagosController {
	...
	@Autowired
	private ReportePagosServiceAPI reportePagosServiceAPI;
	
	@GetMapping(path = "/pagos/download")
	public ResponseEntity<Resource> download(@RequestParam Map<String, Object> params)
			throws JRException, IOException, SQLException {
		ReportePagosDTO dto = reportePagosServiceAPI.obtenerReportePagos(params);
